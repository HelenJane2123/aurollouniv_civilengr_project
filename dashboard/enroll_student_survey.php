                ...
                <div class="col-lg-12">
                    ...
                    ?>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="admin_survey_list.php">Student Survey List</a></li>
                            ...
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body pt-0">
                                    <div class="form-group">
                                        <label for="first" class="text-bold">Survey List</label>
                                ...
                                <div class="card-body pt-0">
                                    <div class="form-group">
                                        <input class="btn btn-primary pull-right" type="Submit" name="enroll_student_survey" value="Enroll">
                                    </div>
                                </div>
                            </div>
                        </form>
