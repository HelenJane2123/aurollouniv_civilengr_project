...
?>
    <h1 class="h3 mb-2 text-gray-800">List of Failed Students</h1>
    <p class="mb-4">Displays list of failed students.</p>
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered rpt_failed_students" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>Student Name</th>
