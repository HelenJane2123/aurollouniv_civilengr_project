    ...
    <div class="student-profile py-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form action="admin/profile_update.php" method="post">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body pt-0">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="teaching_class" value="<?php echo !empty($get_profile_info['teaching_class']) ?
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="section" value="<?php echo !empty($get_profile_info['section']) ?
